...
//                }
                ...
                HStack{
                    ...
                    Button(action: {
                        ...
                        ZStack{
                            ...
                            Image(systemName: "plus").renderingMode(.template).resizable().frame(width:22,height:22).foregroundColor(Color.background)
                        }
            ...
            if (self.lib.cbooks(providerFilter).count == 0){
                ...
                VStack{
                    ...
                    if (self.providerFilter != nil){
                        Text("Add some books to the selected library!").foregroundColor(.white)
